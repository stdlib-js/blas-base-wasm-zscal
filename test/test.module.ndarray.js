...
tape( 'a module instance has an `ndarray` method which scales elements from `x` by `alpha`', function test( t ) {
	var actualX;
	var viewX;
	var mem;
	var mod;
...
tape( 'a module instance has an `ndarray` method which supports a `x` stride', function test( t ) {
	var actualX;
	var viewX;
	var xbuf;
	var mem;
...
tape( 'a module instance has an `ndarray` method which supports a `x` offset', function test( t ) {
	var actualX;
	var viewX;
	var xbuf;
	var mem;
